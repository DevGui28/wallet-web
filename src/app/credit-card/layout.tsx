...
function CreditCardLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex items-center overflow-hidden">
      ...
      <main className="flex min-h-[calc(100vh-40px)] w-full flex-col gap-2 overflow-auto bg-card p-4 md:mx-0 md:my-5 md:ml-[calc(288px+12px)] md:mr-4 md:rounded-3xl">
        <MobileNav />
        {children}
      </main>
    </div>

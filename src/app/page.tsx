export default function Page() {
  return (
    <div className="text-primary-foreground flex h-screen w-screen items-center justify-center gap-5">
      <div className="flex flex-col gap-4 space-y-6 rounded-lg bg-background p-6 text-center">
        ...
        {/* Botão Primário */}
        <button className="text-primary-foreground rounded bg-primary px-4 py-2">
          Botão Primário
        </button>
      ...
      <div className="dark flex flex-col gap-4 space-y-6 rounded-lg bg-background p-6 text-center">
        {/* Fundo Principal */}
        <div className="rounded bg-background p-4 text-foreground">
          Fundo principal com texto primário.
        </div>
